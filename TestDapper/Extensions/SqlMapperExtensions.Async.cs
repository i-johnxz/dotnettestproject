...
namespace Dapper.Contrib.Extensions
{
    public static partial class SqlMapperExtensions
    {
            ...
            int? commandTimeout = null, ISqlAdapter sqlAdapter = null) where T : class
        {
            ...
            return connection.ExecuteAsync(new CommandDefinition(cmd, entityToInsert, transaction, commandTimeout, flags: CommandFlags.Pipelined));
        }
        ...
        public static async Task<bool> UpdateAsync<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var updated = await connection.ExecuteAsync(new CommandDefinition(sb.ToString(), entityToUpdate,
                transaction, commandTimeout, flags: CommandFlags.Pipelined));
        ...
        public static async Task<bool> DeleteAsync<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var deleted = await connection.ExecuteAsync(new CommandDefinition(sb.ToString(), entityToDelete, transaction, commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
        ...
        public static async Task<bool> DeleteAllAsync<T>(this IDbConnection connection, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var deleted = await connection.ExecuteAsync(new CommandDefinition(statement, null, transaction, commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
            return deleted > 0;
        }
    }
}
...
public partial class SqlServerAdapter
{
    ...
    public async Task<int> InsertAsync(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        var multi = await connection.QueryMultipleAsync(new CommandDefinition(cmd, entityToInsert, transaction, commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
...
public partial class SqlCeServerAdapter
{
    ...
    public async Task<int> InsertAsync(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        await connection.ExecuteAsync(new CommandDefinition(cmd, entityToInsert, transaction, commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
        var r = (await connection.QueryAsync<dynamic>(new CommandDefinition("SELECT @@IDENTITY id", transaction: transaction, commandTimeout: commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false)).ToList();
...
public partial class MySqlAdapter
{
        ...
        string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        var cmd = $"INSERT INTO {tableName} ({columnList}) VALUES ({parameterList})";
        await connection.ExecuteAsync(new CommandDefinition(cmd, entityToInsert, transaction, commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
        var r = await connection.QueryAsync<dynamic>(new CommandDefinition("SELECT LAST_INSERT_ID() id", transaction: transaction, commandTimeout: commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
...
public partial class PostgresAdapter
{
    ...
    public async Task<int> InsertAsync(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        var results = await connection.QueryAsync(new CommandDefinition(sb.ToString(), entityToInsert, transaction, commandTimeout, flags: CommandFlags.Pipelined)).ConfigureAwait(false);
...
public partial class FbAdapter
{
    ...
    public async Task<int> InsertAsync(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        var r = await connection.QueryAsync(new CommandDefinition($"SELECT FIRST 1 {keyName} ID FROM {tableName} ORDER BY {keyName} DESC", transaction: transaction, commandTimeout: commandTimeout)).ConfigureAwait(false);
