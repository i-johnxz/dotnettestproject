        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory logger)
        {
            ...
            app.Use(async (context, next) =>
            {
                ...
                while (!result.CloseStatus.HasValue)
                {
                    ...
                    {
                        var clientRequest = Encoding.UTF8.GetString(receiveBuffer.Array, receiveBuffer.Offset,
                            receiveBuffer.Count);
                        ...
                        replyBuffer = new ArraySegment<byte>(bufferSize);
                        result = await socket.ReceiveAsync(replyBuffer, CancellationToken.None);
                    }
                }
            });
